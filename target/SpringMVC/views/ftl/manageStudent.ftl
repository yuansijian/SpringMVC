                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-toolbar clearfix">
                                <form class="well form-search form-horizontal" method="POST"
                                      action="/teacher/manageStudent">
                                    <div class="container">
                            ...
                            <#else>
                                ...
                                <#else>
                                    <#if pageInfo.hasPreviousPage>
                                        <li>
                                            <a href="/teacher/manageStudent?pageNum=${pageInfo.prePage}&pageSize=10">${pageInfo.prePage}</a>
                                        </li>
                                    <#else>
                                        <li><a href="#!">${pageInfo.pageNum}</a></li>
                                    </#if>
                                    <li class="active"><a
                                            href="/teacher/manageStudent?pageNum=2&pageSize=10">${pageInfo.pageNum}</a>
                                    </li>
                                    <#if pageInfo.hasNextPage>
                                        <li>
                                            <a href="/teacher/manageStudent?pageNum=${pageInfo.nextPage}&pageSize=10">${pageInfo.nextPage}</a>
                                        </li>
                                    <#else>
