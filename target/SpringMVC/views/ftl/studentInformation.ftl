                                ...
                                <div class="card-toolbar clearfix">
                                    <form class="well form-search" method="POST" action="/user/studentInformation">
                                        ...
                                        <input class="js-datepicker" data-date-format="yyyy-mm-dd" type="text"
                                               style="width: 150px;" id="registeredStartTime" name="registeredStartTime"
                                               placeholder="从">
                                        &nbsp;&nbsp;===>
                                        <input class="js-datepicker" data-date-format="yyyy-mm-dd" type="text"
                                ...
                                <div class="card-body">
                                          ...
                                          <td>
                                              <div class="btn-group">
                                                  <a class="btn btn-xs btn-default"
                                                     href="/user/editStudentInfo/${student.id}" title="编辑"
                                              ...
                                              <#--<a class="btn btn-xs btn-default" href="/user/deleteStudent/${student.id}" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>-->
                                                  <a onclick="deleteStu(${student.id}, '${student.stuname}')"
                                                     id="delete" class="btn btn-xs btn-default" title="删除"
                                    ...
                                    <nav>
                                        ...
                                        <#elseif (studentList.pages==2)>
                                            <li class="active"><a href="/user/studentInformation?pageNum=1&pageSize=10">1</a>
                                            </li>
                                        ...
                                        <#else>
                                            <#if studentList.isFirstPage>
                                                <li class="active"><a
                                                        href="/user/studentInformation?pageNum=1&pageSize=10">1</a></li>
                                                <li><a href="/user/studentInformation?pageNum=2&pageSize=10">2</a></li>
                                                <li><a href="/user/studentInformation?pageNum=3&pageSize=10">3</a></li>
                                            <#else>
                                                <#if studentList.hasPreviousPage>
                                                    <li>
                                                        <a href="/user/studentInformation?pageNum=${studentList.prePage}&pageSize=10">${studentList.prePage}</a>
                                                    </li>
                                                <#else>
                                                    <li><a href="#!">${studentList.pageNum}</a></li>
                                                </#if>
                                                <li class="active"><a
                                                        href="/user/studentInformation?pageNum=2&pageSize=10">${studentList.pageNum}</a>
                                                </li>
                                                <#if studentList.hasNextPage>
                                                    <li>
                                                        <a href="/user/studentInformation?pageNum=${studentList.nextPage}&pageSize=10">${studentList.nextPage}</a>
                                                    </li>
                                                <#else>
