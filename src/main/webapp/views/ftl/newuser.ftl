          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="newuser.ftl" method="post" onsubmit="return false;">
                  <div class="form-group">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form class="form-inline" action="newuser.ftl" method="post" onsubmit="return false;">
                  <div class="form-group">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form class="form-horizontal" action="newuser.ftl" method="post" onsubmit="return false;">
                  <div class="form-group">
