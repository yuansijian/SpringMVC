            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="file1" class="form-horizontal" action="/community/videoTeacherAchieve" method="post" enctype="multipart/form-data">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <div class="btn-group">
                                                  ...
                                                  <a onclick="deleteVideo(${uploadfile.id}, '${uploadfile.vname}')" class="btn btn-xs btn-default"  title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                                              </div>
                                          </td>
                                      </tr>
                                      </#list>
