                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-toolbar clearfix">
                                    <form class="well form-search" method="POST" action="/community/shortAnswerDatabase">
                                        章节名：
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <div class="btn-group">
                                                  <a class="btn btn-xs btn-default" href="/community/editShort/${list.id}" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                  <a onclick="deletePic(${list.id}, '${list.title}')" class="btn btn-xs btn-default"  title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                                              </div>
                                          </td>
                                      </tr>
                                      </#list>
                                    ...
                                    <nav>
                                        ...
                                        <#elseif (pageInfo.pages==2)>
                                            <li class="active"><a href="/community/shortAnswerDatabase?pageNum=1&pageSize=10">1</a></li>
                                            <li><a href="/community/shortAnswerDatabase?pageNum=2&pageSize=10">2</a></li>
                                        <#elseif (pageInfo.pages == 3)>
                                            <li class="active"><a href="/community/shortAnswerDatabase?pageNum=1&pageSize=10">1</a></li>
                                            <li><a href="#!"></a></li>
                                            <li><a href="/community/shortAnswerDatabase?pageNum=2&pageSize=10">2</a></li>
                                            <li><a href="/community/shortAnswerDatabase?pageNum=3&pageSize=10">3</a></li>
                                        <#else>
                                          <#if pageInfo.isFirstPage>
                                                <li class="active"><a href="/community/shortAnswerDatabase?pageNum=1&pageSize=10">1</a></li>
                                                <li><a href="/community/shortAnswerDatabase?pageNum=2&pageSize=10">2</a></li>
                                          ...
                                          <#else>
                                            ...
                                            <#else>
                                                ...
                                                <li class="active"><a href="/community/shortAnswerDatabase?pageNum=2&pageSize=10">${pageInfo.pageNum}</a></li>
                                            <#if pageInfo.hasNextPage>
                                                    <li><a href="/community/shortAnswerDatabase?pageNum=${pageInfo.nextPage}&pageSize=10">${pageInfo.nextPage}</a></li>
                                            <#else>
