                        ...
                        <div class="card">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <#--<a class="btn btn-xs btn-default" href="/teacher/checkHomework/${hw.id}/${hw.updatetime}" title="查看作业情况" data-toggle="tooltip"><i class="mdi mdi-account"></i></a>-->
                                                            ...
                                                            <a id="reply${hw.id}"  class="btn btn-xs btn-default" onclick="reply2(${hw.id}, '${hw.username}')" href="#!" title="回复" data-toggle="tooltip"><i class="mdi mdi-comment-processing-outline"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </#list>
                            ...
                            <#else>
                                ...
                                <#else>
                                    ...
                                    <li class="active"><a href="/community/manageMessage?pageNum=2&pageSize=10">${pageInfo.pageNum}</a></li>
                                    <#if pageInfo.hasNextPage>
                                        <li><a href="/community/manageMessage?pageNum=${pageInfo.nextPage}&pageSize=10">${pageInfo.nextPage}</a></li>
                                    <#else>
