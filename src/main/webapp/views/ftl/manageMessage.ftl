    ...
    <script>
        function delethw(id) {
            if (confirm("确定删除这个留言吗")) {
                $.ajax({
                    type: "POST",
                    url: "/community/deleteMessage/" + id,
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <ul id="myTabs" class="nav nav-tabs" role="tablist">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" id="myTabDrop1-contents">
                                        <li><a href="#comment" id="student-tab" data-toggle="tab">留言</a></li>
                                        <li><a href="/community/manageReply">回复的留言</a></li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <#--</div>-->
                                                    ...
                                                    <td>
                                                        ...
                                                        <#--<a class="btn btn-xs btn-default" href="/teacher/checkHomework/${hw.id}/${hw.updatetime}" title="查看作业情况" data-toggle="tooltip"><i class="mdi mdi-account"></i></a>-->
                                                            ...
                                                            <a id="reply${hw.id}" class="btn btn-xs btn-default"
                                                               onclick="reply2(${hw.id}, '${hw.username}')" href="#!"
                            ...
                            <#else>
                                <li>
                                    <a href="/community/manageMessage?pageNum=${pageInfo.firstPage}&pageSize=10">
                                        <span><i class="mdi mdi-chevron-left"></i></span>
                                    </a>
                                </li>
                            </#if>
                            ...
                            <#elseif (pageInfo.pages==2)>
                                <li class="active"><a href="/community/manageMessage?pageNum=1&pageSize=10">1</a></li>
                                <li><a href="/community/manageMessage?pageNum=2&pageSize=10">2</a></li>
                            <#elseif (pageInfo.pages == 3)>
                                <li class="active"><a href="/community/manageMessage?pageNum=1&pageSize=10">1</a></li>
                                <li><a href="#!"></a></li>
                                <li><a href="/community/manageMessage?pageNum=2&pageSize=10">2</a></li>
                                <li><a href="/community/manageMessage?pageNum=3&pageSize=10">3</a></li>
                            <#else>
                                <#if pageInfo.isFirstPage>
                                    <li class="active"><a href="/community/manageMessage?pageNum=1&pageSize=10">1</a>
                                    </li>
                                    <li><a href="/community/manageMessage?pageNum=2&pageSize=10">2</a></li>
                                    <li><a href="/community/manageMessage?pageNum=3&pageSize=10">3</a></li>
                                <#else>
                                    <#if pageInfo.hasPreviousPage>
                                        <li>
                                            <a href="/community/manageMessage?pageNum=${pageInfo.prePage}&pageSize=10">${pageInfo.prePage}</a>
                                        </li>
                                    <#else>
                                        <li><a href="#!">${pageInfo.pageNum}</a></li>
                                    </#if>
                                    <li class="active"><a
                                            href="/community/manageMessage?pageNum=2&pageSize=10">${pageInfo.pageNum}</a>
                                    </li>
                                    <#if pageInfo.hasNextPage>
                                        <li>
                                            <a href="/community/manageMessage?pageNum=${pageInfo.nextPage}&pageSize=10">${pageInfo.nextPage}</a>
                                        </li>
                                    <#else>
                                    <#--<li><a href="/community/manageMessage?pageNum=${pageInfo.prePage}&pageSize=10">${pageInfo.prePage - 1}</a></li>-->
                                    <#--<li><a href="/community/manageMessage?pageNum=${pageInfo.prePage}&pageSize=10">${pageInfo.prePage}</a></li>-->
                                    <#--<li><a href="#!">${pageInfo.pageNum}</a></li>-->
                                    </#if>
                                </#if>
                            </#if>
                            ...
                            <#else>
                                <li>
                                    <a href="/community/manageMessage?pageNum=${pageInfo.lastPage}&pageSize=10">
                                        <span><i class="mdi mdi-chevron-right"></i></span>
                                    </a>
                                </li>
                            </#if>
