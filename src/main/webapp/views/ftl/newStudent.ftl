                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <div class="btn-group">
                                                  ...
                                                  <a class="btn btn-xs btn-default"
                                                     href="/user/deleteStudent/${student.id}" title="删除"
                                        ...
                                        <#elseif (studentList.pages==2)>
                                            <li class="active"><a href="/user/newStudent?pageNum=1&pageSize=10">1</a>
                                            </li>
                                        ...
                                        <#else>
                                            <#if studentList.isFirstPage>
                                                <li class="active"><a
                                                        href="/user/newStudent?pageNum=1&pageSize=10">1</a></li>
                                                <li><a href="/user/newStudent?pageNum=2&pageSize=10">2</a></li>
                                                <li><a href="/user/newStudent?pageNum=3&pageSize=10">3</a></li>
                                            <#else>
                                                <#if studentList.hasPreviousPage>
                                                    <li>
                                                        <a href="/user/newStudent?pageNum=${studentList.prePage}&pageSize=10">${studentList.prePage}</a>
                                                    </li>
                                                <#else>
                                                    <li><a href="#!">${studentList.pageNum}</a></li>
                                                </#if>
                                                <li class="active"><a
                                                        href="/user/newStudent?pageNum=2&pageSize=10">${studentList.pageNum}</a>
                                                </li>
                                                <#if studentList.hasNextPage>
                                                    <li>
                                                        <a href="/user/newStudent?pageNum=${studentList.nextPage}&pageSize=10">${studentList.nextPage}</a>
                                                    </li>
                                                <#else>
