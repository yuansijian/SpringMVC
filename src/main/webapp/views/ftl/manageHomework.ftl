                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>${hw.stuname}</td>
                                                <td>${hw.student}</td>
                                                <td><a href="/statics/homework/${hw.fileurl}" download="${hw.fileurl}">作业链接</a>
                                                </td>
                            ...
                            <#else>
                                <#if pageInfo.isFirstPage>
                                    <li class="active"><a href="/teacher/manageHomework?pageNum=1&pageSize=10">1</a>
                                    </li>
                                    <li><a href="/teacher/manageHomework?pageNum=2&pageSize=10">2</a></li>
                                    <li><a href="/teacher/manageHomework?pageNum=3&pageSize=10">3</a></li>
                                <#else>
                                    <#if pageInfo.hasPreviousPage>
                                        <li>
                                            <a href="/teacher/manageHomework?pageNum=${pageInfo.prePage}&pageSize=10">${pageInfo.prePage}</a>
                                        </li>
                                    <#else>
                                        <li><a href="#!">${pageInfo.pageNum}</a></li>
                                    </#if>
                                    <li class="active"><a
                                            href="/teacher/manageHomework?pageNum=2&pageSize=10">${pageInfo.pageNum}</a>
                                    </li>
                                    <#if pageInfo.hasNextPage>
                                        <li>
                                            <a href="/teacher/manageHomework?pageNum=${pageInfo.nextPage}&pageSize=10">${pageInfo.nextPage}</a>
                                        </li>
                                    <#else>
