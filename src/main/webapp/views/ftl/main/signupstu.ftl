...
<div class="card-body">
    <form class="site-form" id="info">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="stumail" id="stumail" aria-describedby="emailHelp"
                   placeholder="请输入正确的邮箱地址" required>
            <small id="emailHelp" class="form-text text-muted">请保证您填写的邮箱地址是正确的。</small>
        </div>
        <div class="form-group">
            <label for="phone">电话号码</label>
            <input type="text" class="form-control" name="stuphone" id="stuphone" aria-describedby="phoneHelp"
                   placeholder="请输入正确的邮箱地址" required>
