                                ...
                                <form method="post" action="/main/changePhoto" enctype="multipart/form-data">
                                    <div class="edit-avatar">
                                        ...
                                        <div>
                                            ...
                                            <img src="/statics/studentHeader/${student.getImageurl()}" alt="..."
                                                 class="img-avatar">
                                        </div>
                                ...
                                <#if student.grade != "teacher">
                                     <form method="post" action="/main/updateProfile" class="site-form">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="stuphone" id="stuphone"
                                      ...
                                      <form method="post" action="/main/updateTeaProfile" class="site-form">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input type="email" class="form-control" name="stumail" id="stumail"
                                                     aria-describedby="emailHelp" placeholder="请输入正确的邮箱地址"
                                                     value="${student.stumail}">
                                              <small id="emailHelp" class="form-text text-muted">请保证您填写的邮箱地址是正确的。
                                              </small>
                                          </div>
                                          <button type="submit" class="btn btn-primary">保存</button>
                                      </form>
