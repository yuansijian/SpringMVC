...
<section class="error-page">
    <div class="error-box">
        ...
        <textarea  style="border:0;border-radius:5px;background-color:rgba(241,241,241,.98);width: 100%;height: 120px;padding: 10px;resize: none;">${pictureTeacher.world}</textarea>
        <#--<nav class="page">-->
            <#--<ul class="pager">-->
            <#--&lt;#&ndash;返回上一页&ndash;&gt;-->
