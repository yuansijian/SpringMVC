    ...
    <#list news as re>
        <div class="col-12">
            <div class="card">
                <ul class="card-actions">
                    <li>
                        <button type="button"><i class="mdi mdi-arrow-up-bold-circle">顶(${re.up})&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                id="replay" style="background: #b4c2cc"
                                onclick="reply1(${re.id}, ${re.parentid}, '${re.username}')">回复</a></i></button>
                    </li>
                </ul>
                <div class="card-body" style="background: #c0c0c0;">
                    <p id="reply${re.id}">
