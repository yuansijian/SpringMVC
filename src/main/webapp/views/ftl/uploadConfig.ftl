                                ...
                                <div class="tab-pane active">
                                    ...
                                    <form id="upload-file" action="" method="post" name="edit-form" class="edit-form">
                                        <div class="form-group">
                                            ...
                                            <input class="js-tags-input form-control" type="text" id="type1"
                                                   name="type1" value="${uploadconfig.type1}">
                                            <small class="help-block">多个后缀用逗号隔开，不填写则不限制类型</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="upload_image_size">图片上传大小限制</label>
                                            <input class="form-control" type="text" id="image" name="image"
                                                   value="${uploadconfig.image}" placeholder="请输入图片上传大小限制">
                                            <small class="help-block">0为不限制大小，单位：kb</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="upload_image_ext">允许上传的图片后缀</label>
                                            <input class="js-tags-input form-control" type="text" id="imageconfig"
                                                   name="imageconfig" value="${uploadconfig.imageconfig}">
                                            <small class="help-block">多个后缀用逗号隔开，不填写则不限制类型</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="upload_file_size">文件上传大小限制</label>
                                            <input class="form-control" type="text" id="limit1" name="limit1"
                                                   value="${uploadconfig.limit1}" placeholder="请输入文件上传大小限制">
                                            <small class="help-block">0为不限制大小，单位：kb</small>
                                        </div>
                                        <div class="form-group">
                                            <button type="button" onclick="upload()" class="btn btn-primary m-r-5">确 定
                                            </button>
