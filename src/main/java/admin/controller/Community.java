...
public class Community
{
    ...
    public int videoTeacherAchieve(@RequestParam("file") MultipartFile multipartFile, Model model, HttpSession session, @RequestParam("description") String description)
    {
    ...
    public String pictureTeacher(@RequestParam(value = "startTime", defaultValue = "1970-01-01") String startTime, Model model, HttpSession session, @RequestParam(value = "endTime", defaultValue = "1970-01-01") String endTime, @RequestParam(value = "name", defaultValue = "") String pname, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize)
    {
        PageHelper.startPage(pageNum, pageSize);
    ...
    public int pictureTeacherAchieve(Model model, HttpSession session, @RequestParam(value = "image") MultipartFile[] multipartFile, @RequestParam(value = "description", defaultValue = "") String word, @RequestParam(value = "pname", defaultValue = "") String pname)
    {
        Administrator administrator = (Administrator) session.getAttribute("user");
    ...
    public int updatePictureTeacher(Model model, HttpSession session, @RequestParam(value = "image") MultipartFile[] multipartFile, @RequestParam(value = "description", defaultValue = "") String word, @RequestParam(value = "pname", defaultValue = "") String pname, @RequestParam(value = "id", defaultValue = "") int id, @RequestParam(value = "iname") String iname[])
    {
    ...
    public String shortAnswerDatabase(@RequestParam(value = "startTime", defaultValue = "1970-01-01") String startTime, Model model, HttpSession session, @RequestParam(value = "endTime", defaultValue = "1970-01-01") String endTime, @RequestParam(value = "keyword", defaultValue = "") String keyword, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize)
    {
        PageHelper.startPage(pageNum, pageSize);
    ...
    public int updateShort(Model model, HttpSession session, @RequestParam(value = "image") MultipartFile[] multipartFile, @RequestParam(value = "content", defaultValue = "") String content, @RequestParam(value = "title", defaultValue = "") String title, @RequestParam(value = "id", defaultValue = "") int id, @RequestParam(value = "answer", defaultValue = "") String answer, @RequestParam(value = "iname") String iname[])
    {
        //        System.out.println("1111111111111111111111");
        //        System.out.println(multipartFile.length);
        //        System.out.println(multipartFile[0].getOriginalFilename());
    ...
    public int shortAchieve(Model model, HttpSession session, @RequestParam(value = "image") MultipartFile[] multipartFile, @RequestParam(value = "content", defaultValue = "") String content, @RequestParam(value = "title", defaultValue = "") String title, @RequestParam(value = "answer", defaultValue = "") String answer)
    {
        Administrator administrator = (Administrator) session.getAttribute("user");
    ...
    public int updateConfig(@RequestParam(value = "logopic") String logopic, HttpSession session, @RequestParam(value = "keyword") String keyword, @RequestParam(value = "description") String description, @RequestParam(value = "copyright") String copyright, @RequestParam(value = "record") String record, @RequestParam(value = "switch1") String switch1, @PathVariable("id") int id)
    {
        Administrator administrator = (Administrator) session.getAttribute("user");
    ...
    public String uploadFile(@RequestParam(value = "startTime", defaultValue = "1970-01-01") String startTime, Model model, HttpSession session, @RequestParam(value = "endTime", defaultValue = "1970-01-01") String endTime, @RequestParam(value = "fileName", defaultValue = "") String fileName, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize)
    {
        PageHelper.startPage(pageNum, pageSize);
    ...
    public int uploadFileAchieve(@RequestParam("file") MultipartFile multipartFile, Model model, HttpSession session, @RequestParam("description") String description)
    {
    ...
    public String manageMessage(HttpSession session, Model model, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize)
    {
        Administrator administrator = (Administrator) session.getAttribute("user");
    ...
    public String manageReply(HttpSession session, Model model, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize)
    {
        PageHelper.startPage(pageNum, pageSize);
        Administrator administrator = (Administrator) session.getAttribute("user");
